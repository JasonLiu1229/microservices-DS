...
"""
import auth_proxy, events_proxy, calendar_proxy, users_proxy, participate_proxy, invite_proxy
import healthcheck
...
app.include_router(participate_proxy.router, prefix="/participation", tags=["participation"])
